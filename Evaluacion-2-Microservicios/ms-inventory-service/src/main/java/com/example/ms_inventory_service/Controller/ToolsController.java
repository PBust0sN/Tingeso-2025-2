...
import com.example.ms_inventory_service.Service.ToolsService;
...
public class ToolsController {
    ...
    @PutMapping("/dropdown")
    public ResponseEntity<Optional<ToolsEntity>> dropdownTool(@RequestParam Long tool_id) {
        Optional<ToolsEntity> updatedTool = toolsService.dropDownATool(tool_id);
